///////////2///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////*Ù2°888888888888888k88888R5555+55455555555555555555555555555555555.+.+++++++++++++++++++/* librairie standard ... */
#include <stdlib.h>
/* pour getopt */
#include <unistd.h>
...
void main (int argc, char **argv){
	...
	/* Variable de message */
	int lg = 30; /* Longeur d'un messages */
	...
	if (nb_message != -1){
        ...
        if(source==1){ 
            ...
            for(i=0; i< nb_message; i++){
                ...
                int i=0;
                while((lg_mess = recv(sock2, pmessage, lg, 0)) != 0){
                    if (lg_mess== -1 ){perror("Echec reception\n");
                    exit(1);}

                    //afficher_message(pmessage, lg_mess);
                    printf("PUITS: Reception n°%d (%d) [%s]\n",i+1, lg, pmessage);
                    i++;
                    }  
                }
